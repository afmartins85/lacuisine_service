...
int LacuisineBindingService::dispatch(struct soap* soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "ns1:CloseUserSessionRequest"))
...
{	struct __ns1__OpenUserSession soap_tmp___ns1__OpenUserSession;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->OpenUserSession(soap_tmp___ns1__OpenUserSession.ns1__OpenUserSessionRequest, ns1__OpenUserSessionResponse);
	if (soap->error)
		return soap->error;
...
{	struct __ns1__CloseUserSession soap_tmp___ns1__CloseUserSession;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->CloseUserSession(soap_tmp___ns1__CloseUserSession.ns1__CloseUserSessionRequest, ns1__CloseUserSessionResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
