...
int LacuisineBindingProxy::send_OpenUserSession(const char *soap_endpoint_url, const char *soap_action, ns1__OpenUserSessionRequestType *ns1__OpenUserSessionRequest)
{
	...
	soap_tmp___ns1__OpenUserSession.ns1__OpenUserSessionRequest = ns1__OpenUserSessionRequest;
	soap_begin(soap);
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___ns1__OpenUserSession(soap, &soap_tmp___ns1__OpenUserSession);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___ns1__OpenUserSession(soap, &soap_tmp___ns1__OpenUserSession, "-ns1:OpenUserSession", "")
...
int LacuisineBindingProxy::send_CloseUserSession(const char *soap_endpoint_url, const char *soap_action, ns1__CloseUserSessionRequestType *ns1__CloseUserSessionRequest)
{
	...
	soap_tmp___ns1__CloseUserSession.ns1__CloseUserSessionRequest = ns1__CloseUserSessionRequest;
	soap_begin(soap);
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
