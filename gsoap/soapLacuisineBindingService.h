...
#ifndef soapLacuisineBindingService_H
#define soapLacuisineBindingService_H
#include "soapH.h"

    class SOAP_CMAC LacuisineBindingService {
      public:
        ...
        LacuisineBindingService();
        /// Copy constructor
        LacuisineBindingService(const LacuisineBindingService&);
        /// Construct service given a shared managing context
        LacuisineBindingService(struct soap*);
        /// Constructor taking input+output mode flags for the new managing context
        LacuisineBindingService(soap_mode iomode);
        /// Constructor taking input and output mode flags for the new managing context
        LacuisineBindingService(soap_mode imode, soap_mode omode);
        /// Destructor deletes deserialized data and its managing context, when the context was allocated by the constructor
        virtual ~LacuisineBindingService();
        /// Delete all deserialized data (with soap_destroy() and soap_end())
        virtual void destroy();
        /// Delete all deserialized data and reset to defaults
        virtual void reset();
        /// Initializer used by constructors
        virtual void LacuisineBindingService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual LacuisineBindingService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        LacuisineBindingService& operator=(const LacuisineBindingService&);
        ...
        virtual int OpenUserSession(ns1__OpenUserSessionRequestType *ns1__OpenUserSessionRequest, ns1__OpenUserSessionResponseType &ns1__OpenUserSessionResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'CloseUserSession' implementation, should return SOAP_OK or error code
        virtual int CloseUserSession(ns1__CloseUserSessionRequestType *ns1__CloseUserSessionRequest, ns1__CloseUserSessionResponseType &ns1__CloseUserSessionResponse) SOAP_PURE_VIRTUAL;
    };
#endif
