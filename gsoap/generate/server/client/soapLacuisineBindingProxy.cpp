...
LacuisineBindingProxy::LacuisineBindingProxy() : soap(SOAP_IO_DEFAULT)
...
LacuisineBindingProxy::LacuisineBindingProxy(const struct soap &_soap) : soap(_soap)
{ }

LacuisineBindingProxy::LacuisineBindingProxy(const struct soap &_soap, const char *soap_endpoint_url) : soap(_soap)
{
	soap_endpoint = soap_endpoint_url;
}

LacuisineBindingProxy::LacuisineBindingProxy(const char *soap_endpoint_url) : soap(SOAP_IO_DEFAULT)
{	LacuisineBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
	soap_endpoint = soap_endpoint_url;
}

LacuisineBindingProxy::LacuisineBindingProxy(soap_mode iomode) : soap(iomode)
{	LacuisineBindingProxy_init(iomode, iomode);
}

LacuisineBindingProxy::LacuisineBindingProxy(const char *soap_endpoint_url, soap_mode iomode) : soap(iomode)
{	LacuisineBindingProxy_init(iomode, iomode);
	soap_endpoint = soap_endpoint_url;
}

LacuisineBindingProxy::LacuisineBindingProxy(soap_mode imode, soap_mode omode) : soap(imode, omode)
...
{	LacuisineBindingProxy *dup = SOAP_NEW_UNMANAGED(LacuisineBindingProxy(*(struct soap*)this));
	return dup;
}
