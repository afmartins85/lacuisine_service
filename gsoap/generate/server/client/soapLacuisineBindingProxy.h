...
#include "soapH.h"
    ...
    class SOAP_CMAC LacuisineBindingProxy : public soap {
      public:
        ...
        LacuisineBindingProxy(const struct soap&);
        /// Construct proxy given a managing context and endpoint URL
        LacuisineBindingProxy(const struct soap&, const char *soap_endpoint_url);
