...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.103 2020-06-02 17:49:15 GMT")
...
{	(void)tag;
	...
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_putelement '%s' failed for type %d in ./clientHMI/soapC.cpp\n", tag ? tag : "", type));
