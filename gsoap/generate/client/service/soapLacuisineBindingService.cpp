...
LacuisineBindingService::LacuisineBindingService() : soap(SOAP_IO_DEFAULT)
...
LacuisineBindingService::LacuisineBindingService(const struct soap &_soap) : soap(_soap)
{ }

LacuisineBindingService::LacuisineBindingService(soap_mode iomode) : soap(iomode)
{	LacuisineBindingService_init(iomode, iomode);
}

LacuisineBindingService::LacuisineBindingService(soap_mode imode, soap_mode omode) : soap(imode, omode)
...
{	LacuisineBindingService *dup = SOAP_NEW_UNMANAGED(LacuisineBindingService(*(struct soap*)this));
	return dup;
}
#endif
...
static int serve___ns1__AccessAuthentication(LacuisineBindingService*);

int LacuisineBindingService::dispatch()
{
	(void)soap_peek_element(this);
	if (!soap_match_tag(this, this->tag, "ns1:AccessAuthenticationRequest"))
		return serve___ns1__AccessAuthentication(this);
	return this->error = SOAP_NO_METHOD;
}

static int serve___ns1__AccessAuthentication(LacuisineBindingService *soap)
{	struct __ns1__AccessAuthentication soap_tmp___ns1__AccessAuthentication;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->AccessAuthentication(soap_tmp___ns1__AccessAuthentication.ns1__AccessAuthenticationRequest, ns1__AccessAuthenticationResponse);
	if (soap->error)
		return soap->error;
