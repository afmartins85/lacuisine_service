...
#include "soapH.h"
    ...
    class SOAP_CMAC LacuisineBindingService : public soap {
      public:
        ...
        LacuisineBindingService(const struct soap&);
        /// Construct service given a managing context and endpoint
        LacuisineBindingService(const struct soap&, const char *soap_endpoint_url);
